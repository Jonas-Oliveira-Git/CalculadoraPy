...
app_label = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivyy 18'),   bg=cor3, fg=cor2)
...
#creat button
#first line button
b_1 = Button(frame_corpo, command =limpar_tela ,text="C", width=11, height=2, bg=cor4, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE )
b_1.place(x=0,y=0)
